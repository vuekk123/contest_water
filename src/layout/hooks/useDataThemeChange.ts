...
export function useDataThemeChange() {
  ...
  function dataThemeChange() {
    ...
    if (dataTheme.value) {
      ...
      if (document.querySelector('.loginbgpic')) {
        document.querySelector('.loginbgpic').classList.add("loginbgpicdark")
      }
    } else {
      document.documentElement.classList.remove("dark");
      if (document.querySelector('.loginbgpic')) {
        document.querySelector('.loginbgpic').classList.remove("loginbgpicdark")
      }
    }
  }
