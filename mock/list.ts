      ...
      return {
        ...
        data: {
          list: [
            ...
            {
              created_at: "2022-12-19T01:11:18Z",
              published_at: "2022-12-19T01:15:11Z",
            ...
            },
            {
              ...
              body: "# 3.9.5 (2022-12-13)\r\n\r\n### ✔️ refactor\r\n\r\n- 完全移除了 `lodash` 和其相关库\r\n  [点击此处查看为什么移除？如何自行集成？](https://yiming_chang.gitee.io/pure-admin-doc/pages/FAQ/#%E5%B9%B3%E5%8F%B0%E5%9C%A8-v3-9-5-%E7%89%88%E6%9C%AC%E5%AE%8C%E5%85%A8%E7%A7%BB%E9%99%A1%E1%BA%86-lodash-%E5%92%8C%E5%85%B6%E7%9B%B8%E5%85%B3%E5%BA%93-%E1%B8%BA%E1%BB%80%E1%B9%88%E7%A7%BB%E9%99%A1-%E5%A6%82%E1%BD%95%E8%87%AA%E8%A1%8C%E9%9B%86%E6%88%90)\r\n\r\n### 🎫 Feat\r\n\r\n- 添加 `@pureadmin/table` 表格动态列示例\r\n\r\n### 🐞 Bug fixes\r\n\r\n- 修复动态路由 `rank` 问题\r\n- 修复暗黑主题样式问题\r\n\r\n### 🍏 Perf\r\n\r\n- 优化路由 `rank` ，当 `rank` 不存在时，根据顺序自动创建，首页路由永远在第一位"
            },
            {
              created_at: "2022-12-05T05:59:51Z",
              published_at: "2022-12-05T06:01:01Z",
              body: "# 3.9.1 (2022-12-05)\r\n\r\n### ✔️ refactor\r\n\r\n- 完全移除了 `vxe-table`，移除后，完整版整体打包大小减少 `1.82MB`，首启动时长基本和精简版持平 🐮\r\n  [点击此处查看为什么移除？如何自行集成？](https://yiming_chang.gitee.io/pure-admin-doc/pages/FAQ/#%E5%B9%B3%E5%8F%B0%E5%9C%A8-v3-9-1-%E7%89%88%E6%9C%AC%E5%AE%8C%E5%85%A8%E7%A7%BB%E9%99%A1%E1%BA%86-vxe-table-%E1%B8%BA%E1%BB%80%E1%B9%88%E7%A7%BB%E9%99%A1-%E5%A6%82%E1%BD%95%E8%87%AA%E8%A1%8C%E9%9B%86%E6%88%90)\r\n\r\n### 🎫 Feat\r\n\r\n- 添加 `@pureadmin/table` 表格选择器（单选、多选）示例"
            },
            {
              created_at: "2022-12-01T08:15:17Z",
              published_at: "2022-12-01T08:16:59Z",
              body: "# 3.9.3 (2022-12-01)\r\n\r\n### 🎫 Feat\r\n\r\n- 添加 `@pureadmin/table` 分页和加载动画示例\r\n\r\n### 🐞 Bug fixes\r\n\r\n- 修复开启 `CachingAsyncRoutes` 后，存入本地存储的动态路由改变造成刷新页面空白的问题\r\n- 修复菜单折叠后 `Tooltip` 显示异常\r\n\r\n### 🍏 Perf\r\n\r\n- 扩展本地图标使用方式，完整版首启动再次减少 `13` 个请求\r\n- 当菜单加载慢时，添加 `loading` 动画，优化用户体验\r\n- 主题初始化放在 `onBeforeMount` 里，避免初始化页面闪烁"
            },
            {
              created_at: "2022-12-03T07:02:17Z",
              published_at: "2022-12-03T07:03:09Z",
              body: "# 3.9.2 (2022-12-03)\r\n\r\n### 🍏 Perf\r\n\r\n- 全局覆盖 `element-plus` 的 `el-dialog`、`el-drawer`、`el-message-box`、`el-notification` 组件右上角关闭图标的样式，使其表现更鲜明 [具体代码修改记录](https://github.com/xiaoxian521/vue-pure-admin/commit/c80818d792276666aaea1b18113a0f08777f2ed1)\r\n- 打包输出信息兼容不同打包输出路径\r\n- 优化一些动画"
            },
            {
              created_at: "2022-12-02T11:32:18Z",
              published_at: "2022-12-02T11:33:15Z",
            ...
            },
            {
              ...
              body: "# 3.9.0 (2022-11-30)\r\n\r\n### 🐞 Bug fixes\r\n\r\n- 修复退出全屏时文字过长导致页面出现滚动条后带来的抖动问题\r\n- 修复一些类型错误\r\n\r\n### 🍏 Perf\r\n\r\n- perf: 首屏加载大优化，对比 `3.9.0` 之前版本，首屏请求减少 `71` 个，首屏加载资源减少 `1.1 MB`"
            },
            {
              created_at: "2022-11-27T17:25:13Z",
            ...
            {
              created_at: "2022-11-27T08:31:16Z",
              published_at: "2022-11-27T08:35:19Z",
            ...
            },
            {
              ...
              published_at: "2022-11-26T16:01:11Z",
              body: "# 3.8.5 (2022-11-26)\r\n\r\n### 🍏 Perf\r\n\r\n- 大优化，移除 `@pureadmin/components` 并采用兼容写法，平台打包大小在未启用压缩前对比优化前减少 `0.1` MB , 首屏请求减少 `2.3` MB 的资源，这对于 [精简版](https://github.com/xiaoxian521/pure-admin-thin) 来说是非常大的优化，精简版已经同步代码"
            },
            {
            ...
            {
              created_at: "2022-11-21T17:00:01Z",
              published_at: "2022-11-21T17:00:12Z",
              body: "# 3.7.1 (2022-11-22)\r\n\r\n### 🔥 hotfix\r\n\r\n- 修复在未开启标签页缓存时退出登录，可能存在标签页未重置的问题"
            },
            {
              created_at: "2022-11-21T09:11:22Z",
              published_at: "2022-11-21T09:15:21Z",
            ...
            {
              created_at: "2022-10-27T01:58:11Z",
              published_at: "2022-10-27T01:59:32Z",
              body: "# 3.6.2 (2022-10-27)\r\n\r\n### ✔️ refactor\r\n\r\n- 使用`@/`别名替换`/@/`别名"
            },
            {
              created_at: "2022-10-26T18:12:33Z",
              published_at: "2022-10-26T18:13:31Z",
              body: "# 3.6.1 (2022-10-27)\r\n\r\n### 🎫 Feat\r\n\r\n- 添加打包是否启动`cdn`替换本地库配置，默认`false`不启动\r\n- 添加打包构建可选`gzip`与`brotli`压缩模式\r\n\r\n### 🐞 Bug fixes\r\n\r\n- 修复`title`过长显示样式问题\r\n- 修复路由中父级`name`不应和子级`name`重复，会造成重定向跳转`101`问题\r\n\r\n### 🍏 Perf\r\n\r\n- 升级`axios`至最新版"
            },
            {
            ...
            {
              created_at: "2022-09-10T13:11:17Z",
              published_at: "2022-09-10T13:16:11Z",
            ...
            {
              created_at: "2022-03-03T11:57:11Z",
              published_at: "2022-03-03T11:57:55Z",
            ...
            {
              created_at: "2022-02-11T15:19:32Z",
              published_at: "2022-02-11T15:20:32Z",
              body: "# 3.0 (2022-2-11)\r\n\r\n### 🎫 Feat\r\n\r\n- 添加混合导航\r\n\r\n### 🐞 Bug fixes\r\n\r\n- 修复标签页 bug"
            },
            {
            ...
            {
              created_at: "2022-01-21T08:16:18Z",
              published_at: "2022-01-21T08:19:38Z",
              body: "# 2.8.5(2022-1-21)\r\n\r\n### 🎫 Feat\r\n\r\n- 添加 `WindiCSS` 支持\r\n- 添加线上环境删 console 插件`vite-plugin-remove-console`\r\n\r\n### ✔️ refactor\r\n\r\n- 使用`@iconify-icons/ep`替换`@element-plus/icons-vue`"
            },
            {
              created_at: "2022-01-01T11:52:05Z",
              published_at: "2022-01-01T11:53:17Z",
